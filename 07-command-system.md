...
반대로 이 장은 각 command 구현의 세부 로직, tool permission 모델, plugin system 전체를 다루지 않는다. tool surface와 permission은 [08-tool-system-and-permissions.md](./08-tool-system-and-permissions.md)에서 이어서 다룬다.
