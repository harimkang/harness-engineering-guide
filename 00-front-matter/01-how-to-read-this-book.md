...
이 장은 다섯 가지를 먼저 고정한다. 첫째, 독자용 출판 범위와 내부 작업 문서의 경계를 나눈다. 둘째, `README`, 이 문서, 방법론 appendix, 참고문헌 appendix, 용어집의 역할을 구분한다. 셋째, 이 책이 사용하는 주장 층위와 출처 규칙을 설명한다. 넷째, 원칙 spine과 사례 spine을 어떻게 왕복할지 정리한다. 다섯째, 코드 블록과 Mermaid를 어떤 증거 규칙 아래 읽어야 하는지 짚는다.

## 처음 읽는 독자를 위한 아주 짧은 시작점

이 장이 길게 느껴진다면 먼저 아래 네 가지만 잡고 시작해도 된다.
...
4. 처음에는 [README.md](../README.md), 이 문서, [appendix/source-analysis-method.md](02-source-analysis-method.md), [appendix/references.md](03-references.md)를 함께 놓고 보는 편이 안전하다.

나머지 본문은 이 네 문장을 더 엄밀하게 풀어 쓴 규칙집이라고 생각하면 된다.
...
대표 자료 목록과 canonical source registry는 [appendix/references.md](03-references.md)에 모아 두었다. 이 장의 역할은 개별 source를 모두 다시 나열하는 데 있지 않다. 더 중요한 일은 "이 책이 무엇을 근거로 무엇을 말하는가"를 독자가 헷갈리지 않게 만드는 것이다.

## 이 장의 범위

- `README.md`, 이 문서, 방법론 appendix, 참고문헌 appendix, 용어집의 역할 구분
- 독자용 출판 범위와 제외 범위
...
- [README.md](../README.md)
  메인 인덱스다. 독자용 범위, Part 지도, 시작 경로, reader-facing apparatus를 가장 빨리 보여준다.
- [00-how-to-read-this-book.md](01-how-to-read-this-book.md)
  서문이자 독서 규칙 장이다. 이 책의 reading model과 주장 층위를 설명한다.
- [appendix/source-analysis-method.md](02-source-analysis-method.md)
  근거와 발췌 규칙을 더 압축적으로 모아 둔 참조 부록이다.
- [appendix/references.md](03-references.md)
  Anthropic engineering 글, Platform 문서, 연구 논문의 canonical registry다.
- [appendix/glossary.md](../08-reference/01-glossary.md)
  반복되는 핵심 용어를 정의와 차이, 추적 file과 함께 모은다.

즉, `README`는 길 안내를 하고, `00`은 읽는 법을 가르치며, 방법론 appendix는 규칙을 요약하고, references appendix는 source를 고정하며, glossary는 용어를 정리한다.
...
1. 원칙 spine
   `foundations/**`부터 `evaluation/**`까지다. 하네스 설계의 일반 언어를 만든다.
2. 사례 spine
   `01`부터 `17`까지의 평면 장이다. Claude Code 공개 사본에서 그 언어가 실제로 어떻게 드러나는지 보여준다.
...
| --- | --- | --- |
| context와 control | [context/01-context-as-an-operational-resource.md](../03-context-and-control/01-context-as-an-operational-resource.md) | [05-context-assembly-and-query-pipeline.md](../03-context-and-control/05-claude-code-context-assembly-and-query-pipeline.md), [06-query-engine-and-turn-lifecycle.md](../03-context-and-control/06-claude-code-query-engine-and-turn-lifecycle.md) |
| tool과 permission | [interfaces/01-tool-contracts-and-the-agent-computer-interface.md](../04-interfaces-and-operator-surfaces/01-tool-contracts-and-the-agent-computer-interface.md), [interfaces/02-tool-shaping-permissions-and-capability-exposure.md](../04-interfaces-and-operator-surfaces/02-tool-shaping-permissions-and-capability-exposure.md) | [08-tool-system-and-permissions.md](../04-interfaces-and-operator-surfaces/07-claude-code-tool-system-and-permissions.md) |
| evaluator-driven harness | [foundations/05-evaluator-driven-harness-design.md](../01-foundations/05-evaluator-driven-harness-design.md), [evaluation/06-contract-based-qa-and-skeptical-evaluators.md](../07-evaluation-and-synthesis/06-contract-based-qa-and-skeptical-evaluators.md) | [17-end-to-end-scenarios.md](../07-evaluation-and-synthesis/07-claude-code-end-to-end-scenarios.md), [15-code-reading-guide.md](../07-evaluation-and-synthesis/08-benchmark-oriented-code-reading-guide.md) |
| end-to-end synthesis | [evaluation/03-benchmarking-coding-harnesses.md](../07-evaluation-and-synthesis/03-benchmarking-long-running-agent-harnesses.md) | [17-end-to-end-scenarios.md](../07-evaluation-and-synthesis/07-claude-code-end-to-end-scenarios.md) |
...
- canonical registry는 [appendix/references.md](03-references.md)에 유지한다.
...
2. [00-how-to-read-this-book.md](01-how-to-read-this-book.md)
3. [appendix/source-analysis-method.md](02-source-analysis-method.md)
4. [appendix/references.md](03-references.md)
5. Part I-VI 원칙 spine
6. `01`~`17` 사례 spine
...
- context: [context/01-context-as-an-operational-resource.md](../03-context-and-control/01-context-as-an-operational-resource.md) -> [05-context-assembly-and-query-pipeline.md](../03-context-and-control/05-claude-code-context-assembly-and-query-pipeline.md)
- tools: [interfaces/01-tool-contracts-and-the-agent-computer-interface.md](../04-interfaces-and-operator-surfaces/01-tool-contracts-and-the-agent-computer-interface.md) -> [08-tool-system-and-permissions.md](../04-interfaces-and-operator-surfaces/07-claude-code-tool-system-and-permissions.md)
- long-running execution: [execution/03-task-orchestration-and-long-running-execution.md](../05-execution-continuity-and-integrations/02-task-orchestration-and-long-running-execution.md) -> [12-task-model-and-background-execution.md](../05-execution-continuity-and-integrations/06-claude-code-task-model-and-background-execution.md)
- eval artifact: [evaluation/01-model-evals-vs-harness-evals.md](../07-evaluation-and-synthesis/01-model-evals-vs-harness-evals.md) -> [17-end-to-end-scenarios.md](../07-evaluation-and-synthesis/07-claude-code-end-to-end-scenarios.md)
- evaluator-driven harness: [foundations/05-evaluator-driven-harness-design.md](../01-foundations/05-evaluator-driven-harness-design.md), [evaluation/06-contract-based-qa-and-skeptical-evaluators.md](../07-evaluation-and-synthesis/06-contract-based-qa-and-skeptical-evaluators.md) -> [17-end-to-end-scenarios.md](../07-evaluation-and-synthesis/07-claude-code-end-to-end-scenarios.md)

### source-first 모드

1. [15-code-reading-guide.md](../07-evaluation-and-synthesis/08-benchmark-oriented-code-reading-guide.md)
2. [appendix/key-file-index.md](../08-reference/02-key-file-index.md)
3. 필요한 사례 장
4. 대응하는 원칙 장
...
2. [00-how-to-read-this-book.md](01-how-to-read-this-book.md)
3. [appendix/source-analysis-method.md](02-source-analysis-method.md)
4. [01-project-overview.md](../02-runtime-and-session-start/03-claude-code-project-overview.md)
...
2. [00-how-to-read-this-book.md](01-how-to-read-this-book.md)
3. [appendix/source-analysis-method.md](02-source-analysis-method.md)
4. [02-architecture-map.md](../02-runtime-and-session-start/04-claude-code-architecture-map.md)
5. [05-context-assembly-and-query-pipeline.md](../03-context-and-control/05-claude-code-context-assembly-and-query-pipeline.md)
6. [08-tool-system-and-permissions.md](../04-interfaces-and-operator-surfaces/07-claude-code-tool-system-and-permissions.md)
7. [12-task-model-and-background-execution.md](../05-execution-continuity-and-integrations/06-claude-code-task-model-and-background-execution.md)

### evaluator-heavy harness를 읽고 싶을 때

1. [README.md](../README.md)
2. [appendix/references.md](03-references.md)
3. [foundations/05-evaluator-driven-harness-design.md](../01-foundations/05-evaluator-driven-harness-design.md)
4. [context/03-compaction-memory-and-handoff-artifacts.md](../03-context-and-control/03-compaction-memory-and-handoff-artifacts.md)
5. [evaluation/02-tasks-trials-transcripts-and-graders.md](../07-evaluation-and-synthesis/02-tasks-trials-transcripts-and-graders.md)
6. [evaluation/06-contract-based-qa-and-skeptical-evaluators.md](../07-evaluation-and-synthesis/06-contract-based-qa-and-skeptical-evaluators.md)
7. [evaluation/03-benchmarking-coding-harnesses.md](../07-evaluation-and-synthesis/03-benchmarking-long-running-agent-harnesses.md)
...
1. [15-code-reading-guide.md](../07-evaluation-and-synthesis/08-benchmark-oriented-code-reading-guide.md)
2. [appendix/key-file-index.md](../08-reference/02-key-file-index.md)
3. [03-runtime-modes-and-entrypoints.md](../02-runtime-and-session-start/05-claude-code-runtime-modes-and-entrypoints.md)
...
이 책은 단순한 source 해설서가 아니라, 사례 기반 하네스 엔지니어링 교재를 지향한다. 따라서 독자는 각 장을 읽을 때 제품 사실, 공개 설계 원칙, 저자 해석, 설계 권고를 구분해야 한다. 코드 블록은 증거이고, 메르메이드는 구조 지도이며, 벤치마크 질문은 이 책이 사례를 교재로 바꾸는 핵심 장치다. 실제 분석 전제와 발췌 원칙은 [appendix/source-analysis-method.md](02-source-analysis-method.md)를 함께 보면 더 분명해진다.
