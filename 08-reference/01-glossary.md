...
- 대표 근거 라벨: 본문은 주로 문서적 비교를 수행하며, 구현 기준점은 [05-harness-benchmark-framework.md](../07-evaluation-and-synthesis/05-harness-benchmark-framework.md)에 모여 있다
...
- glossary는 주로 Tier 6 local terminology index로 작동하지만, 용어의 바깥 framing은 [../00-front-matter/01-how-to-read-this-book.md](../00-front-matter/01-how-to-read-this-book.md)와 [../00-front-matter/02-source-analysis-method.md](../00-front-matter/02-source-analysis-method.md)의 claim/status 규칙을 따른다.
- stable appendix이지만, 제품 고유 용어가 drift하면 관련 Part guide와 함께 다시 확인한다.
