...
- 대표 근거 라벨: 본문은 주로 문서적 비교를 수행하며, 구현 기준점은 [evaluation/05-claude-code-benchmark-framework.md](../07-evaluation-and-synthesis/05-harness-benchmark-framework.md)에 모여 있다
