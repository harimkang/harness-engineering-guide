...
또한 아래 구분은 현재 공개 build에서 확인 가능한 packaging semantics를 기준으로 하며, built-in plugin, marketplace plugin, bundled skill의 경계는 추후 packaging 변화와 함께 다시 확인해야 한다.
...
- [../11-agent-skill-plugin-mcp-and-coordination.md](../11-agent-skill-plugin-mcp-and-coordination.md)
