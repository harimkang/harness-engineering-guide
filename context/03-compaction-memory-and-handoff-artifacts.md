...
이 주제들은 [../execution/02-state-resumability-and-session-ownership.md](../execution/02-state-resumability-and-session-ownership.md), [../execution/03-task-orchestration-and-long-running-execution.md](../execution/03-task-orchestration-and-long-running-execution.md), [../13-persistence-config-and-migrations.md](../13-persistence-config-and-migrations.md)에서 확장한다.
