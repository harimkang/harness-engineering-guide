...
이 장은 [01-ui-transcripts-and-operator-control.md](./01-ui-transcripts-and-operator-control.md), [02-state-resumability-and-session-ownership.md](./02-state-resumability-and-session-ownership.md), [../12-task-model-and-background-execution.md](../12-task-model-and-background-execution.md)와 이어진다.
