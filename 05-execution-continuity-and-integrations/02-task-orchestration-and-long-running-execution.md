...
이 장의 reader-facing 외부 검증 축은 [../00-front-matter/03-references.md](../00-front-matter/03-references.md)의 Part 5 cluster를 따른다. 핵심 source ID는 `S2`, `S6`, `S8`, `S26`, `S27`, `S32`, `S33`이며, `P1`은 artifact durability 비교의 보조 프레임으로만 사용한다.
