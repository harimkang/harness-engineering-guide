...
이 장의 reader-facing 외부 검증 축은 [../00-front-matter/03-references.md](../00-front-matter/03-references.md)의 Part 6 cluster를 따른다. deployment family, auth handshake, data path, version-negotiation framing에는 `S5`, `S15`, `S20`, `S30`, `S31`을 우선 사용한다. `P1`은 boundary artifact 비교의 보조 프레임으로만 사용한다.
