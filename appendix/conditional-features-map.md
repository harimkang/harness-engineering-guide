...
이 부록은 feature gate와 conditional path만 따로 추적하는 지도다. 일반 구조는 [directory-map.md](./directory-map.md), 핵심 파일 탐색은 [key-file-index.md](./key-file-index.md)와 역할이 다르다.
...
- 실행 모드 관점: [03-runtime-modes-and-entrypoints.md](../03-runtime-modes-and-entrypoints.md)
- startup/trust 관점: [04-session-startup-trust-and-initialization.md](../04-session-startup-trust-and-initialization.md)
- extension/coordination 관점: [11-agent-skill-plugin-mcp-and-coordination.md](../11-agent-skill-plugin-mcp-and-coordination.md)
- 구조 리스크 관점: [16-risks-debt-and-observations.md](../16-risks-debt-and-observations.md)
