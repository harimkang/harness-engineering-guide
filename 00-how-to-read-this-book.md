...
4. 처음에는 [README.md](./README.md), 이 문서, [appendix/source-analysis-method.md](./appendix/source-analysis-method.md), [appendix/references.md](./appendix/references.md)를 함께 놓고 보는 편이 안전하다.
...
대표 자료 목록과 canonical source registry는 [appendix/references.md](./appendix/references.md)에 모아 두었다. 이 장의 역할은 개별 source를 모두 다시 나열하는 데 있지 않다. 더 중요한 일은 "이 책이 무엇을 근거로 무엇을 말하는가"를 독자가 헷갈리지 않게 만드는 것이다.
...
- canonical registry는 [appendix/references.md](./appendix/references.md)에 유지한다.
...
2. [00-how-to-read-this-book.md](./00-how-to-read-this-book.md)
3. [appendix/source-analysis-method.md](./appendix/source-analysis-method.md)
4. [01-project-overview.md](./01-project-overview.md)
...
1. [15-code-reading-guide.md](./15-code-reading-guide.md)
2. [appendix/key-file-index.md](./appendix/key-file-index.md)
3. [03-runtime-modes-and-entrypoints.md](./03-runtime-modes-and-entrypoints.md)
...
이 책은 단순한 source 해설서가 아니라, 사례 기반 하네스 엔지니어링 교재를 지향한다. 따라서 독자는 각 장을 읽을 때 제품 사실, 공개 설계 원칙, 저자 해석, 설계 권고를 구분해야 한다. 코드 블록은 증거이고, 메르메이드는 구조 지도이며, 벤치마크 질문은 이 책이 사례를 교재로 바꾸는 핵심 장치다. 실제 분석 전제와 발췌 원칙은 [appendix/source-analysis-method.md](./appendix/source-analysis-method.md)를 함께 보면 더 분명해진다.
