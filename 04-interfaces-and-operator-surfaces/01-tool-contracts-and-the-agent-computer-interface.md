...
이 장의 reader-facing 외부 검증 축은 [../00-front-matter/03-references.md](../00-front-matter/03-references.md)의 Part 4 cluster를 따른다. 핵심 source ID는 `S3`, `S9`, `S10`, `S12`, `S13`, `S14`, `S15`, `S25`이며, `S2`는 shared tooling/provenance 비교의 보조 프레임으로만 사용한다.

함께 읽으면 좋은 장:

- [02-context-classes-boundaries-and-scopes.md](../03-context-and-control/02-context-classes-boundaries-and-scopes.md)
